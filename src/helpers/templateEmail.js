async function templateEmail(name, link) {
    return `<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="center" style="padding-bottom: 20px;">
                            <img src="https://placehold.co/150x50/4F46E5/ffffff?text=SEU+LOGO" alt="Logo" width="150" style="display: block; border-radius: 5px;">
                        </td>
                    </tr>
                </table>
